<div class="container mt-5">
    <div class="text-center titulo-duvidas">
        <h2>NUNCA NAVEGOU EM UM FÓRUM DE DISCUSSÃO E TEM DÚVIDAS?</h2>
        <h4>Acesse os cards abaixo e saiba como se comprotar em um fórum de discussão.</h4>
    </div>
    <div class="row">
